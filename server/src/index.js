...
let showConsole = !!(process.stdin && process.stdin.isTTY && process.stdout && process.stdout.isTTY);
...
Log.info("\u001B[1m\u001B[32mNOX Arena " + gameServer.version + "\u001B[37m - Local gameplay build on the repo mechanics base.\u001B[0m");
gameServer.start();
if (showConsole) {
